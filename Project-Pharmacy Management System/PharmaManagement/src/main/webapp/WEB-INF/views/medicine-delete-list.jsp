...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/medicine-delete-list.css"/>
...
<table border="1">
		...
		<c:url var="deleteLink" value="/deleteMedicine">
			...
			<tr>
				...
				<td><a href="${deleteLink}" onclick="if(!(confirm('Are you sure to delete'))) return false" class="red">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
